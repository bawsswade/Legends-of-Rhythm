    ...
    public class InuptManager : MonoBehaviour
    {
        ...
        private static Dictionary<INPUTTYPE, System.Func<float>> PS4Axis =
            new Dictionary<INPUTTYPE, System.Func<float>>
            {
                ...
                { INPUTTYPE.Dash, ()=> AvgAxis(() => Input.GetAxis("PS4_R_Analog_X"), () =>Input.GetAxis("PS4_R_Analog_Y"))},
        ...
        // get average axis rot for dashes
        ...
        /*public static string GetButtonName(INPUTTYPE it)
        {
            return Names[currentControls][it];
        }*/
